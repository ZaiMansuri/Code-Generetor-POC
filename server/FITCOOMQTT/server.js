...
module.exports = {
    data(port, username, password) {
        return `const mqttCallbackService = require("./callback");
        module.exports = { 
            startServer() {
        ...
        aedes.authorizePublish = function (client, packet, callback) {
            ...
            if (data.a) {
                //manage your business logic here 
            }
            callback(null);
        };
...
module = {
    ...
    startServer() {
        ...
        aedes.authorizePublish = function (client, packet, callback) {
            ...
            if (data.mt) {
                mqttCallbackService[`mt${data.mt}Received`](imei, data);
            } else {
                mqttCallbackService.otherDataReceived(topic, data);
            }
